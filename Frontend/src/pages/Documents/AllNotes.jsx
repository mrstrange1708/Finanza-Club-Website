...
export default function AllNotes() {
    ...
    useEffect(() => {
        const fetchNotes = async () => {
            try {
                ...
                const notes = response.data.filter(d => d.type === 'note');
                setAllNotes(notes);
    ...
    useEffect(() => {
        ...
        if (selectedDate) {
            results = results.filter(note => {
                const noteDate = new Date(note.date || note.month).toDateString();
    ...
    }, [searchQuery, selectedCategory, sortBy, selectedDate, allNotes]);
        ...
        <div className="min-h-screen bg-white pt-24 pb-32">
            ...
            <section className="max-w-7xl mx-auto px-6 md:px-12 mb-12">
                <div className="flex flex-col items-center text-center">
                    <h1 className="text-4xl md:text-5xl font-bold text-[#C0003D] mb-4">All Event Notes</h1>
                    <div className="h-1 w-20 bg-[#C0003D] mb-6"></div>
                    <p className="text-gray-600 max-w-3xl text-lg leading-relaxed">
                        Explore our complete collection of event notes and insights. Use the filters below to find specific topics.
                    </p>
                </div>
            </section>
                ...
                <div className="bg-white border border-gray-200 rounded-3xl p-6 shadow-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        <div className="md:col-span-2 relative">
                            ...
                            <input
                                type="text"
                                placeholder="Search event notes by title or description..."
                                value={searchQuery}
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                        <p className="text-sm font-medium text-gray-600">
                            Showing <span className="text-[#C0003D] font-bold">{filteredNotes.length}</span> of <span className="font-bold">{allNotes.length}</span> event notes
                        </p>
            ...
            <section className="max-w-7xl mx-auto px-6 md:px-12">
                {filteredNotes.length > 0 ? (
                    ...
                    <div className="text-center py-20 bg-gray-50 rounded-3xl">
                        ...
                        <h3 className="text-2xl font-bold text-gray-800 mb-2">No event notes found</h3>
                        <p className="text-gray-600 mb-6 max-w-md mx-auto">
                            We couldn't find any event notes matching your current filters. Try adjusting your search or filters.
                        </p>
                        <button
                            onClick={clearFilters}
